          ...
          <div className="sticky top-24 flex flex-col gap-4">
            ...
            <div className="flex gap-3 justify-center">
              {product.images.map((imgUrl, index) => (
                <div
                  key={index}
                  className={`w-20 h-20 rounded-lg cursor-pointer overflow-hidden transition-all duration-300 ${
                    selectedImage === index
          ...
          <div className="py-8">
            ...
            >
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-primary hover:bg-primary-light text-white font-bold text-lg px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 shadow-lg"
              >
                <FiShoppingCart />
                Añadir al Carrito
              </button>
              ...
              <Accordion title="Especificaciones">
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    <FiBox className="text-primary dark:text-primary-dark" />{" "}
                    <strong>Tamaño:</strong> {product.size}
                  </li>
                  <li className="flex items-center gap-3">
                    <FiFeather className="text-primary dark:text-primary-dark" />{" "}
                    <strong>Peso:</strong> {product.weight}
                  </li>
                  <li className="flex items-center gap-3">
                    <FiDroplet className="text-primary dark:text-primary-dark" />{" "}
                    <strong>Color:</strong> {product.color}
                  </li>
                  <li className="flex items-center gap-3">
                    <FiZap className="text-primary dark:text-primary-dark" />{" "}
